...
Window = Library:CreateWindow({
    Title = "King Hub",
    Desc = "- Blox Fruit (Version 3.0)",
    Image = "rbxassetid://9180622670"
})
...
Library:Notify({
    Title = "",
    Description = "Chào mừng! UI đã được load thành công.\nNhấn nút góc trái màn hình để mở GUI.",
    Duration = 4
})
...
Tabs.Info:AddButton({
    ...
    ["Description"] = "Discord",
    ["Callback"] = function()
        setclipboard(tostring("https://dsc.gg"))
    end
})
Tabs.Info:AddButton({
    ["Title"] = "",
    ["Description"] = "Youtube",
    ["Callback"] = function()
        setclipboard(tostring("https://youtube.com"))
    end
})
Tabs.Info:AddButton({
    ["Title"] = "",
    ["Description"] = "Tiktok",
    ["Callback"] = function()
        setclipboard(tostring("www.tiktok.com))
    end
})
...
-- ===============================================================
print('✅ King Hub - Tất cả tính năng đã được load!')
